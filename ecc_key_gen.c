...
int main(){
    ...
    write_public_key_pem(&mbedtlsPkContext, "publickey.pem");
    write_private_key_pem(&mbedtlsPkContext, "privatekey.pem");
    write_public_key_der(&mbedtlsPkContext, "publickey.der");
    write_private_key_der(&mbedtlsPkContext, "privatekey.der");
}
